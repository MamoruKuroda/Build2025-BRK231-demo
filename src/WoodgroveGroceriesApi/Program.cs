...
// Add Application Insights - always add the service but with different configurations
builder.Services.AddApplicationInsightsTelemetry(options =>
{
    // In development, use a dummy connection string or disable entirely
    ...
    {
        // Use the actual connection string in production
        options.ConnectionString = builder.Configuration["ApplicationInsights:ConnectionString"];
    }
});

// Configure TelemetryInitializer to enrich data only in production
if (!builder.Environment.IsDevelopment())
{
